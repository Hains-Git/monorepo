...
-- CreateIndex
CREATE UNIQUE INDEX "_User Gruppes_AB_unique" ON "_User Gruppes"("A", "B");

-- CreateIndex
CREATE INDEX "_User Gruppes_B_index" ON "_User Gruppes"("B");
...
-- AddForeignKey
ALTER TABLE "users" ADD CONSTRAINT "users_account_info_id_fkey" FOREIGN KEY ("account_info_id") REFERENCES "account_infos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_User Gruppes" ADD CONSTRAINT "_User Gruppes_A_fkey" FOREIGN KEY ("A") REFERENCES "gruppes"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_User Gruppes" ADD CONSTRAINT "_User Gruppes_B_fkey" FOREIGN KEY ("B") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
