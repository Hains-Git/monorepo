...
CREATE TABLE "freigabestatuses" (
    ...
    "created_at" TIMESTAMP(6) NOT NULL,
    "updated_at" TIMESTAMP(6) NOT NULL,
    "counts_active" BOOLEAN DEFAULT false,
    "sys" BOOLEAN DEFAULT false,
    "color" VARCHAR,
    "beschreibung" VARCHAR,
    "qualifiziert" BOOLEAN DEFAULT false,
...
CREATE TABLE "hains_tasks" (
    ...
    "created_at" TIMESTAMP(6) NOT NULL,
    "updated_at" TIMESTAMP(6) NOT NULL,
    "als_popup" BOOLEAN DEFAULT false,
    "gruppe_id" INTEGER,
...
CREATE TABLE "notfallmedizin_statuses" (
    ...
    "created_at" TIMESTAMP(6) NOT NULL,
    "updated_at" TIMESTAMP(6) NOT NULL,
    "send_mitarbeiter_email" BOOLEAN DEFAULT false,
    "send_verwaltung_email" BOOLEAN DEFAULT false,
...
CREATE TABLE "planparameters" (
    ...
    "reuse_bedarf" BOOLEAN DEFAULT false,
...
CREATE TABLE "vertrags" (
    ...
    "kommentar" VARCHAR NOT NULL DEFAULT '',
...
CREATE TABLE "vertrags_variantes" (
    ...
    "vertragstyp_id" INTEGER,
    "name" VARCHAR,
    "wochenstunden" INTEGER DEFAULT 0,
    "created_at" TIMESTAMP(6) NOT NULL,
    "updated_at" TIMESTAMP(6) NOT NULL,
