...
function TwoColSaal({
  ...
  const room = po_dienst.oberarzt ? '' : 'room';
  ...
  return (
    <div
      className={`content-row ${content_layout} ${room} ${isInSearch() ? styles.highlight : ''}`}
    >
      <div className="columns">
        {employee && po_dienst.oberarzt === false && (
          <div className="col">
            <Saal bereich_section={bereich_section} einteilung={einteilung} />
          </div>
        )}
