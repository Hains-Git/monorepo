...
/**
 * Klasse für die Untergruppen Bereich-Tagesverteiler im Tagesverteiler.
 * @class VerteilerBereichTagesverteiler
 */
class VerteilerBereichTagesverteiler extends Basic{
  constructor(obj, parent, appModel = false) {
    ...
    this._setInteger("tagesverteiler_id", obj?.tagesverteiler_id);
...
export default VerteilerBereichTagesverteiler;